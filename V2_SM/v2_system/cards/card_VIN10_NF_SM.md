# Evidence Card — VIN10_NF_SM

| Field | Value |
|---|---|
| VIN | `VIN10_NF_SM` |
| Tier (production prob) | **[GREEN]** |
| Production probability | `0.2439` |
| OOF probability (honest) | `0.4349` ([AMBER]) |
| Failed | `No` |
...
|---|---|---|---|---|---|---|---|
| 1 | `vsi_withinwk_std_ratio_30d_w` | `0.7764` | `17.6`th | `-0.747` | `-0.6621` | protective | within-week voltage noise is 0.78x own baseline — low 18th fleet percentile; z=-0.75 |
| 2 | `rest_vsi_p05_delta90` | `-1.1231` | `17.6`th | `-1.102` | `+0.2979` | toward failure | rest-voltage floor delta = -1.123 V vs own baseline — strong sagging (battery cascade risk); z=-1.10, 18th fleet pctile |
...
Reducing rest_vsi_p05_delta90 by 0.313 units (from -1.123 to -1.436) would move production prob below 0.35 (GREEN threshold), all else equal. [delta_z = -0.376]
