# Evidence Card — VIN11_NF_SM

| Field | Value |
|---|---|
| VIN | `VIN11_NF_SM` |
| Tier (production prob) | **[GREEN]** |
| Production probability | `0.0727` |
| OOF probability (honest) | `0.1211` ([GREEN]) |
| Failed | `No` |
...
|---|---|---|---|---|---|---|---|
| 1 | `vsi_withinwk_std_ratio_30d_w` | `0.9051` | `29.4`th | `-0.537` | `-0.4762` | protective | within-week voltage noise is 0.91x own baseline — low 29th fleet percentile; z=-0.54 |
...
| 3 | `rest_vsi_p05_delta90` | `0.3128` | `73.5`th | `+0.624` | `-0.1686` | protective | rest-voltage floor delta = +0.313 V vs own baseline — stable/rising; z=+0.62, 74th fleet pctile |
...
Reducing vsi_range_trend by 0.060 units (from 0.000 to -0.060) would move production prob below 0.35 (GREEN threshold), all else equal. [delta_z = -0.924]
