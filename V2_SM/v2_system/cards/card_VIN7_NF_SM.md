# Evidence Card — VIN7_NF_SM

| Field | Value |
|---|---|
| VIN | `VIN7_NF_SM` |
| Tier (production prob) | **[GREEN]** |
| Production probability | `0.0928` |
| OOF probability (honest) | `0.1431` ([GREEN]) |
| Failed | `No` |
...
|---|---|---|---|---|---|---|---|
| 1 | `vsi_withinwk_std_ratio_30d_w` | `0.9800` | `44.1`th | `-0.415` | `-0.3679` | protective | within-week voltage noise is 0.98x own baseline — moderate 44th fleet percentile; z=-0.42 |
...
| 3 | `rest_vsi_p05_delta90` | `0.2347` | `70.6`th | `+0.530` | `-0.1433` | protective | rest-voltage floor delta = +0.235 V vs own baseline — stable/rising; z=+0.53, 71th fleet pctile |
| 4 | `dip_depth_last90_delta` | `-0.3223` | `17.6`th | `-0.635` | `-0.0894` | protective | crank dip depth delta = -0.322 V vs baseline — stable/shallow; z=-0.63, 18th fleet pctile |
...
Reducing vsi_range_trend by 0.052 units (from 0.000 to -0.052) would move production prob below 0.35 (GREEN threshold), all else equal. [delta_z = -0.796]
