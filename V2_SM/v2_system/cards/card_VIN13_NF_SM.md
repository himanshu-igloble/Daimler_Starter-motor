# Evidence Card — VIN13_NF_SM

| Field | Value |
|---|---|
| VIN | `VIN13_NF_SM` |
| Tier (production prob) | **[GREEN]** |
| Production probability | `0.0866` |
| OOF probability (honest) | `0.1460` ([GREEN]) |
| Failed | `No` |
...
|---|---|---|---|---|---|---|---|
| 1 | `vsi_range_trend` | `0.0708` | `82.4`th | `+0.635` | `-0.2628` | protective | drive-voltage range trend = +0.0708 V/wk — widening (risk direction univariately); z=+0.63, 82th fleet pctile; NOTE: multivariate suppressor (see coefficient table) |
| 2 | `vsi_withinwk_std_ratio_30d_w` | `1.1709` | `73.5`th | `-0.104` | `-0.0921` | protective | within-week voltage noise is 1.17x own baseline — elevated 74th fleet percentile; z=-0.10 |
| 3 | `rest_vsi_p05_delta90` | `-0.0080` | `47.1`th | `+0.238` | `-0.0644` | protective | rest-voltage floor delta = -0.008 V vs own baseline — slight decline; z=+0.24, 47th fleet pctile |
...
Already GREEN — no counterfactual needed.
