# Evidence Card — VIN19_NF_SM

| Field | Value |
|---|---|
| VIN | `VIN19_NF_SM` |
| Tier (production prob) | **[GREEN]** |
| Production probability | `0.0892` |
| OOF probability (honest) | `0.1968` ([GREEN]) |
| Failed | `No` |
...
|---|---|---|---|---|---|---|---|
| 1 | `vsi_withinwk_std_ratio_30d_w` | `0.9875` | `50.0`th | `-0.403` | `-0.3571` | protective | within-week voltage noise is 0.99x own baseline — moderate 50th fleet percentile; z=-0.40 |
...
| 3 | `dip_depth_last90_delta` | `-0.7932` | `11.8`th | `-1.137` | `-0.1602` | protective | crank dip depth delta = -0.793 V vs baseline — stable/shallow; z=-1.14, 12th fleet pctile |
| 4 | `rest_vsi_p05_delta90` | `0.0763` | `58.8`th | `+0.340` | `-0.0918` | protective | rest-voltage floor delta = +0.076 V vs own baseline — stable/rising; z=+0.34, 59th fleet pctile |
...
Reducing vsi_range_trend by 0.053 units (from 0.000 to -0.053) would move production prob below 0.35 (GREEN threshold), all else equal. [delta_z = -0.817]
