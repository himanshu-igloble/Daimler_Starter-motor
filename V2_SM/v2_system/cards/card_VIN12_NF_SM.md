# Evidence Card — VIN12_NF_SM

| Field | Value |
|---|---|
| VIN | `VIN12_NF_SM` |
| Tier (production prob) | **[GREEN]** |
| Production probability | `0.0495` |
| OOF probability (honest) | `0.0909` ([GREEN]) |
| Failed | `No` |
...
|---|---|---|---|---|---|---|---|
| 1 | `vsi_withinwk_std_ratio_30d_w` | `0.8830` | `23.5`th | `-0.573` | `-0.5081` | protective | within-week voltage noise is 0.88x own baseline — low 24th fleet percentile; z=-0.57 |
| 2 | `rest_vsi_p05_delta90` | `0.4638` | `85.3`th | `+0.805` | `-0.2177` | protective | rest-voltage floor delta = +0.464 V vs own baseline — stable/rising; z=+0.81, 85th fleet pctile |
...
Reducing vsi_range_trend by 0.073 units (from 0.000 to -0.073) would move production prob below 0.35 (GREEN threshold), all else equal. [delta_z = -1.119]
