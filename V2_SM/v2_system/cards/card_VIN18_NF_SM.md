# Evidence Card — VIN18_NF_SM

| Field | Value |
|---|---|
| VIN | `VIN18_NF_SM` |
| Tier (production prob) | **[GREEN]** |
| Production probability | `0.0729` |
| OOF probability (honest) | `0.2352` ([GREEN]) |
| Failed | `No` |
...
|---|---|---|---|---|---|---|---|
| 1 | `vsi_withinwk_std_ratio_30d_w` | `0.8260` | `20.6`th | `-0.666` | `-0.5904` | protective | within-week voltage noise is 0.83x own baseline — low 21th fleet percentile; z=-0.67 |
...
| 3 | `dip_depth_last90_delta` | `-0.9043` | `8.8`th | `-1.256` | `-0.1769` | protective | crank dip depth delta = -0.904 V vs baseline — stable/shallow; z=-1.26, 9th fleet pctile |
| 4 | `rest_vsi_p05_delta90` | `-0.5588` | `23.5`th | `-0.424` | `+0.1146` | toward failure | rest-voltage floor delta = -0.559 V vs own baseline — mild sagging; z=-0.42, 24th fleet pctile |
...
Reducing vsi_range_trend by 0.060 units (from 0.000 to -0.060) would move production prob below 0.35 (GREEN threshold), all else equal. [delta_z = -0.922]
