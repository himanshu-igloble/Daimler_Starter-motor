# Evidence Card — VIN4_NF_SM

| Field | Value |
|---|---|
| VIN | `VIN4_NF_SM` |
| Tier (production prob) | **[GREEN]** |
| Production probability | `0.0709` |
| OOF probability (honest) | `0.1178` ([GREEN]) |
| Failed | `No` |
...
|---|---|---|---|---|---|---|---|
| 1 | `vsi_withinwk_std_ratio_30d_w` | `0.9139` | `32.4`th | `-0.523` | `-0.4634` | protective | within-week voltage noise is 0.91x own baseline — low 32th fleet percentile; z=-0.52 |
...
| 3 | `rest_vsi_p05_delta90` | `0.3253` | `76.5`th | `+0.639` | `-0.1727` | protective | rest-voltage floor delta = +0.325 V vs own baseline — stable/rising; z=+0.64, 76th fleet pctile |
| 4 | `dip_depth_last90_delta` | `0.1226` | `32.4`th | `-0.160` | `-0.0226` | protective | crank dip depth delta = +0.123 V vs baseline — borderline; z=-0.16, 32th fleet pctile |
...
| First channel / first fire date | `A1_crank_burst` / `2025-07-04` | — |
...
Reducing vsi_range_trend by 0.061 units (from 0.000 to -0.061) would move production prob below 0.35 (GREEN threshold), all else equal. [delta_z = -0.937]
