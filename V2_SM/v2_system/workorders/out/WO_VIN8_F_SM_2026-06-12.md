...
**Evidence summary:** H1_momentum(Δprob=+0.351); persistence_terminal(active)

**Model probability:** 0.697 (tier: RED)
**Physics mode:** Data silence (SMA dead) with/without prior VSI signals; abrupt failure with minimal observable precursor

### Top-3 Drivers
1. **vsi_range_trend** (toward failure)  
   drive-voltage range trend = -0.0444 V/wk — flat/narrowing; z=-1.14, 6th fleet pctile; NOTE: multivariate suppressor (see coefficient table)  
   Contribution: +0.470 std | z=-1.14 | fleet p6
2. **vsi_withinwk_std_ratio_30d_w** (protective)  
   within-week voltage noise is 1.14x own baseline — elevated 68th fleet percentile; z=-0.15  
   Contribution: -0.137 std | z=-0.15 | fleet p68
3. **rest_vsi_p05_delta90** (toward failure)  
   rest-voltage floor delta = -0.389 V vs own baseline — mild sagging; z=-0.22, 35th fleet pctile  
   Contribution: +0.059 std | z=-0.22 | fleet p35

### Channel History
- First channel: **persistence** @ 2025-07-14  
- Persistent RED streak: 1 weeks  
