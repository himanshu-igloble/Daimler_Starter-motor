...
**Evidence summary:** H1_momentum(Δprob=+0.317)

**Model probability:** 0.593 (tier: RED)
...
2. **rest_vsi_p05_delta90** (protective)  
   rest-voltage floor delta = +0.183 V vs own baseline — stable/rising; z=+0.47, 65th fleet pctile  
   Contribution: -0.126 std | z=0.47 | fleet p65
3. **vsi_withinwk_std_ratio_30d_w** (toward failure)  
   within-week voltage noise is 1.26x own baseline — elevated 76th fleet percentile; z=+0.04  
   Contribution: +0.039 std | z=0.04 | fleet p76
