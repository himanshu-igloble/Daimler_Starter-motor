...
**Model probability:** 0.669 (tier: RED)
...
1. **vsi_range_trend** (toward failure)  
   drive-voltage range trend = -0.0800 V/wk — flat/narrowing; z=-1.68, 3th fleet pctile; NOTE: multivariate suppressor (see coefficient table)  
   Contribution: +0.697 std | z=-1.68 | fleet p3
2. **vsi_withinwk_std_ratio_30d_w** (protective)  
   within-week voltage noise is 0.94x own baseline — low 35th fleet percentile; z=-0.49  
   Contribution: -0.432 std | z=-0.49 | fleet p35
3. **rest_vsi_p05_delta90** (toward failure)  
   rest-voltage floor delta = -0.655 V vs own baseline — mild sagging; z=-0.54, 21th fleet pctile  
   Contribution: +0.146 std | z=-0.54 | fleet p21

### Channel History
- First channel: **persistence** @ 2025-01-06  
